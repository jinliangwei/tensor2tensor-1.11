...
@registry.register_hparams
def transformer_topk_32_packed():
  hparams = transformer_base_vq_ada_32ex_packed()
  hparams.gating_type = "topk"
  hparams.moe_num_experts = 32
  hparams.moe_k = 2
...
@registry.register_hparams
def transformer_topk_64_packed():
  hparams = transformer_base_vq_ada_32ex_packed()
  hparams.gating_type = "topk"
...
@registry.register_hparams
def transformer_topk_128_packed():
  hparams = transformer_base_vq_ada_32ex_packed()
  hparams.gating_type = "topk"
...
@registry.register_hparams
def transformer_topk_96_packed():
  hparams = transformer_base_vq_ada_32ex_packed()
  hparams.gating_type = "topk"
  hparams.moe_num_experts = 96
  hparams.moe_k = 2
  return hparams

@registry.register_hparams
def transformer_topk_196_packed():
  hparams = transformer_base_vq_ada_32ex_packed()
  hparams.gating_type = "topk"
  hparams.moe_num_experts = 196
  hparams.batch_size = 634
  hparams.moe_k = 2
  return hparams
